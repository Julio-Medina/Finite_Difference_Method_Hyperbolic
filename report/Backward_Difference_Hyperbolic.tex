...
\end{equation}
resolviendo para $w_{i,j+1}$ la aproximación más adelantada en el tiempo, se obtiene
...
w_{0,j}=w_{m,j}=0,\,\,\,\forall\,\,\,j=1,2,3,\hdots,
\end{equation}
y las condiciones iniciales implican que
\begin{equation}
w_{i,0}=f(x), \,\,\, \forall\,\, i=1,2,\hdots,m-1
\end{equation}
...
\begin{equation}
w_{i,1}=w_{i,0}+kg(x_i),\,\,\,\,\forall\,\,\, i=1,2,\hdots,m-1.
\end{equation}
